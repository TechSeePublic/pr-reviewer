 ...
 */
import { AIProvider, ArchitecturalReviewResult, CodeIssue, CursorRule, FileChange, PRPlan, ReviewContext } from '../types';
export declare abstract class BaseAIProvider implements AIProvider {
    ...
    abstract reviewBatch(files: FileChange[], rules: CursorRule[], prPlan: PRPlan): Promise<CodeIssue[]>;

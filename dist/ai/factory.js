...
class AIProviderFactory {
    static create(inputs) {
        ...
        if (provider === 'bedrock') {
            return new bedrock_provider_1.BedrockProvider(inputs.bedrockRegion, model, inputs.deterministicMode, inputs.bedrockAccessKeyId, inputs.bedrockSecretAccessKey, inputs.bedrockAnthropicVersion, inputs.bedrockApiKey);
        }

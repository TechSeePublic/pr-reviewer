...
class AzureOpenAIProvider {
    constructor(apiKey, endpoint, apiVersion, model, realModel, deterministicMode = true) {
        this.name = 'azure';
    ...
    async reviewArchitecture(fileChanges, rules) {
        try {
            ...
            logger_1.logger.error('Azure OpenAI architectural review error:', error);
...
class AIProviderFactory {
    static create(inputs) {
        ...
        if (provider === 'azure') {
            ...
            return new AzureOpenAIProvider(inputs.azureOpenaiApiKey, inputs.azureOpenaiEndpoint, inputs.azureOpenaiApiVersion || '2024-10-21', model, inputs.azureOpenaiRealModel, inputs.deterministicMode);
        }

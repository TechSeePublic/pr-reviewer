...
export declare function getModelInfo(model: string): {
    ...
    readonly tier: "premium";
    readonly description: "Latest Claude 3.5 Sonnet on Bedrock with enhanced reasoning";
    readonly bestFor: readonly ["complex-code-analysis", "detailed-reviews", "architectural-review"];
} | {
    readonly provider: "bedrock";
    readonly tier: "premium";
    readonly description: "Most capable Claude model on Bedrock for complex reasoning";
    readonly bestFor: readonly ["thorough-reviews", "complex-reasoning", "architectural-analysis"];
} | {
    readonly provider: "bedrock";
    readonly tier: "standard";
    readonly description: "Fast and cost-effective Claude model on Bedrock";
    readonly bestFor: readonly ["quick-reviews", "large-prs", "cost-effective-analysis"];
} | {
    readonly provider: "bedrock";
    readonly tier: "premium";
    readonly description: "Large Llama 3.2 model with strong reasoning capabilities";
    readonly bestFor: readonly ["complex-analysis", "thorough-reviews", "code-generation"];
} | {
    readonly provider: "bedrock";
    readonly tier: "premium";
    readonly description: "Amazon Titan Premier model with advanced text generation";
    readonly bestFor: readonly ["text-generation", "documentation-review", "content-analysis"];
};
...
export declare const MODEL_CAPABILITIES: {
    ...
    readonly 'amazon.titan-text-premier-v1:0': {
        readonly provider: "bedrock";
        readonly tier: "premium";
        readonly description: "Amazon Titan Premier model with advanced text generation";
        readonly bestFor: readonly ["text-generation", "documentation-review", "content-analysis"];
...
export declare const COMMENT_MARKERS: {
    ...
    readonly ARCHITECTURAL_MARKER: "<!-- cursor-ai-architectural -->";
};

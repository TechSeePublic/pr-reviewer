...
class CommentManager {
     ...
     */
    generateGitHubFileURL(fileName, lineNumber, _fileChanges, _postedComments) {
        ...
        if (lineNumber && lineNumber > 0) {
            ...
            logger_1.logger.debug(`📁 Generated file+line URL: ${attemptURL}`);
            logger_1.logger.debug(`🧪 File: ${fileName}, Line: ${lineNumber}`);
            return attemptURL;
        }
        // No line number - just link to files page
        logger_1.logger.debug(`📁 Generated files page URL: ${filesURL}`);
        logger_1.logger.debug(`🧪 File: ${fileName} (no line number)`);
        return filesURL;
    }
    /**

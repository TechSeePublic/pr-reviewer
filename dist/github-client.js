    ...
    async postInlineComment(comment, existingCommentId) {
        try {
            ...
            if (existingCommentId) {
                ...
                logger_1.logger.info(`✅ Successfully posted inline comment at ${comment.location.file}:${comment.location.line}`);
            }
        }
        catch (error) {
            ...
            if (errorMessage.includes('line') || errorMessage.includes('position') || errorMessage.includes('422')) {

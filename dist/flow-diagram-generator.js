...
\`\`\``;
                    ...
                    try {
                        ...
                        if (jsonMatch) {
                            ...
                            return {
                                ...
                                mainFlow: parsed.mainFlow || ['User action', 'System processing', 'Result displayed']
                            };
                        }
                    }
                    catch (e) {
    ...
    determineStepType(step, index, totalSteps) {
        ...
        if (lowerStep.includes('validate') || lowerStep.includes('check') || lowerStep.includes('verify')) {
            return 'process';
        }
        if (lowerStep.includes('save') || lowerStep.includes('store') || lowerStep.includes('process')) {
            return 'data';
        }
        return 'process';
    }

 ...
 */
import { ActionInputs, AIProvider, CodeIssue, FileChange, PRContext, PRPlan, ReviewResult } from './types';
...
export declare class CommentManager {
     ...
     */
    private cleanupOrphanedComments;
    /**
     ...
     */
    enhanceIssuesWithOriginalCode(issues: CodeIssue[], fileChanges: FileChange[]): CodeIssue[];
    /**
     * Extract original code from diff for a specific issue
     */
    private extractOriginalCodeFromDiff;
    /**
     * Find corresponding deletion for an addition (for replacements)
     */
    private findCorrespondingDeletion;
    /**

...
export class AutoFixManager {
  ...
  private async createAutoFixSummaryComment(fixes: AutoFixResult[]): Promise<void> {
    ...
    body += `\n---\n*<img src="https://raw.githubusercontent.com/amitwa1/pr-reviewer/main/assets/techsee-logo.png" width="16" height="16" alt="TechSee"> Generated by TechSee AI PR Reviewer Auto-Fix*`;
